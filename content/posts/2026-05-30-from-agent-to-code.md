---
layout: post
title: "从 Agent 到代码：Claude Code 编排模型的演进，以及 Dynamic Workflows 到底改变了什么"
description: "Claude Code 的 Dynamic Workflows 把编排逻辑从「Claude 脑子里想的」变成了「JS 代码跑的」。但这不是凭空出现的——它是一条清晰演进路径的终点。本文分析这条路径，并用 bmad-automator 项目作为中间态的活样本，解释每一步到底退出了什么。"
date: 2026-05-30 14:00:00 +0800
categories: [AI, 开发方法]
tags: [Claude Code, Dynamic Workflows, Agent编排, BMAD, 自动化]
---
...
<img src="https://i.v2ex.co/HfIsGV9nl.png" alt="协作模型的演进" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
