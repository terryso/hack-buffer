...
- **第 1 篇**：[Axion 入门：用自然语言控制你的 Mac](/posts/axion-desktop-automation-intro)
- **第 2 篇**：[Axion 架构解析：四模块设计与 MCP 协议](/posts/axion-architecture-four-modules)
- **第 3 篇**：[Axion 核心引擎：Plan-Execute-Verify 循环](/posts/axion-plan-execute-verify-engine)
- **第 4 篇**：Axion 记忆与技能：越用越聪明的桌面助手（本文）
- **第 5 篇**：[Axion 集成生态：从命令行到全平台](/posts/axion-integration-ecosystem)
