...
const SITE_URL = 'https://blog.suchuanyi.dev';
...
export function blogPostToTweets(filename, postsDir = '../content/posts') {
...
export function listRecentPosts(postsDir = '../content/posts', limit = 10) {
